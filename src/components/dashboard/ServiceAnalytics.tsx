            ...
            <Card className="hover:shadow-card-hover transition-all duration-300">
              <CardContent className="pt-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge
                    variant="outline"
                    style={{ borderColor: rateColor(s.completionRate), color: rateColor(s.completionRate) }}
                    className="text-[10px]"
                  >
                ...
                <div className="mt-3 flex items-center justify-between text-xs text-muted-foreground">
                  <span>Hours: {fmtHours(s.hPlanned)} planned</span>
                  <span className={s.hDelivered > s.hPlanned ? "text-amber-500" : "text-emerald-500"}>
                    {fmtHours(s.hDelivered)} actual
                  </span>
                </div>
              </CardContent>
            </Card>
